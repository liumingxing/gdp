...
FCKCommands.RegisterCommand( 'Bidparams', new FCKDialogCommand( 'Bidparams', FCKLang.DlgBidDocParamsTitle, '/bid_project/bid_tbparams_for_editor', 540, 260 ) ) ;

// Create the "Plaholder" toolbar button.
var oBidparamsItem = new FCKToolbarButton( 'Bidparams', FCKLang.DlgBidDocParams , null, null, null, null, 156) ;
oBidparamsItem.IconPath = FCKPlugins.Items['bidparams'].Path + 'bidparams.gif' ;

FCKToolbarItems.RegisterItem( 'Bidparams', oBidparamsItem ) ;
